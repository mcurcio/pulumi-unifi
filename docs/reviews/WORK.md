...
| D-M3.2 | Per-resource `siteId`: KEPT+hardened (framework already honors it) | D | 2 | M | S0.1, S0.2, A-M0.2 | ☑ |
| D-M3.3 | `Voucher`/`AdoptDevice`: excluded as resources (data-only; reads kept) | D | 2 | M | S0.2, A-M0.2 | ☑ |
